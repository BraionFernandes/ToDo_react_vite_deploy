...
export default function Editor(props){
    ...
    return(
        <div className='editor'>
            <div className='editor--close--div close--div'><button className='editor--close--button close--button material-symbols-outlined' onClick={CloseEditor}>close</button></div>
            <p className='editor--title'>Editor</p>
            <div className='editor--tarefa--div'>
                {props.dadosEdit && props.dadosEdit.length > 0 &&(
                    <div className='editor--tarefa'>
                        <div className='editor--tarefa--text'>
                            <p className='editor--tarefa--title'>Tarefa nome:</p>
                            <p className='editor--tarefa--name'>{props.dadosEdit[0].text}</p>
                        </div>
                        <div className='editor--tarefa--buttons'>
                            <button className='editor--tarefa--button--edit' onClick={isEditVisible ? handCloseEdit : handOpenEdit}><i className='material-symbols-outlined'>edit</i>Editar</button>
                            <button className='editor--tarefa--button--delet' onClick={DeletVisible ? handCloseDelet : handOpenDelet}><i className='material-symbols-outlined'>delete</i>Excluir</button>
                        </div>
                    </div>
                )}
            </div>
            {isEditVisible &&(
                <div className='editor--form--container'>
                    <div className='editor--form--body'>
                        <div className='editor--form--body--close--div close--div'><button className='editor--form--body--close--button close--button material-symbols-outlined' onClick={handCloseEdit}>close</button></div>
                        <form onSubmit={handleSubmit} className='editor--form'>
                            ...
                            <input type="submit" className='editor--form--input' value="Alterar"/>
                        </form>
                    </div>
                </div>
            )}
                ...
                <div className='delete--container'>
                    <div className='delete'>
                        ...
                        <div className='delete--buttons'>
                            <button className='delete--button--confirm' onClick={()=> removeElemento(props.dadosEdit[0].id)}>Confirmar</button>
                            <button className='delete--button--cancel' onClick={DeletVisible ? handCloseDelet : handOpenDelet}>Cancelar</button>
                        </div>
                    </div>
                </div>
            )}
